    ...
    <div className="space-y-8">
      <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm md:p-8">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <div>
            <label className="mb-2 block text-sm font-medium text-gray-700">Curb Weight (lbs)</label>
            ...
            <p className="mt-2 text-xs text-gray-500">Weight of empty vehicle</p>
          </div>
          <div>
            <label className="mb-2 block text-sm font-medium text-gray-700">GVWR (lbs)</label>
            <input type="number" inputMode="numeric" value={gvwr || ""} onChange={(e) => setGvwr(Number(e.target.value) || 0)}
              placeholder="e.g., 7050" className="w-full rounded-lg border border-gray-300 px-4 py-3 text-base focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-500 md:py-2 md:text-sm" />
            <p className="mt-2 text-xs text-gray-500">From door jamb sticker</p>
          </div>
          <div>
          ...
          <div className="md:col-span-2">
            <label className="mb-2 block text-sm font-medium text-gray-700">Tongue / Pin Weight (lbs)</label>
            <input type="number" inputMode="numeric" value={tongueWeight || ""} onChange={(e) => setTongueWeight(Number(e.target.value) || 0)}
              placeholder="e.g., 910 (13% of 7000 lb trailer)" className="w-full rounded-lg border border-gray-300 px-4 py-3 text-base focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-500 md:py-2 md:text-sm" />
            <p className="mt-2 text-xs text-gray-500">Weight transferred from trailer to truck</p>
          </div>
        </div>
